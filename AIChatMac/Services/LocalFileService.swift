...
class LocalFileService {
    ...
    private func createAIPrompt(issueAnalysis: String, issueDescription: String, directoryPath: String, projectAnalysis: String) -> String {
        ...
        **АНАЛИЗ ПРОЕКТА:**
        ...
        ВАЖНО: Используй информацию об анализе проекта выше для создания файла, адаптированного именно под этот проект!
        
        **Создание файла:**
        Если это GitHub Actions (ci.yml):
